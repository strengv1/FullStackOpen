...
import {
  BrowserRouter as Router, Routes, Route, Link, useNavigate, useMatch
...
const App = () => {
  ...
  return (
    <>
      ...
      { notification }
      <Routes>
        <Route path="/anecdotes/:id" element={<Anecdote anecdote={anecdoteFromId} />} /> 
